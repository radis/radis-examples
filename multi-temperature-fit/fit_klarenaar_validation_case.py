...
from radis.spectrum.compare import get_residual, get_residual_integral
...
def theoretical_model(model_input):
    ...
    # ... create whatever model below (can have several slabs, etc.)
    s = sf.non_eq_spectrum((T12, T12, T3), Trot, Ttrans=Trot,
                           vib_distribution='treanor',
                           name='treanor. fit')
    
    # ... output should remain a Spectrum
    return s
...
#    return get_residual_integral(s, s_exp, fit_variable, ignore_nan=True)
